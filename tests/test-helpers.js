...
export const testVersions = [
  ...
  [
    'ember-cli-4.4',
    ['ember-data@^4.13.0-alpha.5', 'ember-inflector', 'ember-cli@~4.12.0'],
  ],
  [
    'ember-cli-4.8',
    ['ember-data@^4.13.0-alpha.5', 'ember-inflector', 'ember-cli@~4.12.0'], // ember-cli 4.12 is the earliest version that will work
  ],
